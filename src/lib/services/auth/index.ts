...
export const loginService =
  (axios: AxiosInstance) =>
  async (param: LoginServiceRequest): Promise<LoginServiceResponse> => {
    try {
...
export const changePasswordService =
  (axios: AxiosInstance) =>
  async (param: ChangePasswordServiceRequest): Promise<DefaultServiceResponse> => {
    try {
...
export const changeProfilePictureService =
  (axios: AxiosInstance) =>
  async (picture: File): Promise<DefaultServiceResponse & { result: string }> => {
    try {
